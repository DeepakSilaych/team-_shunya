...
$(function () {
    ...
    // for the team
    $('#team-relative, #team-list, #team').mouseover(function () {
        $(this).css('cursor', 'pointer')
...
var index=0;
translate_active_image=-60;
translate_next1_image=-53.6170212766;
...
$('#carousel-button2').click(function(){
    clearInterval(interval);
    clearInterval(button_interval);
    $('#carousel-image1').css('transform', 'translateX(-60vw)');
    $('#carousel-image2').css('transform','translateX(-53.6170212766vw)');
...
$('#carousel-button3').click(function(){
    clearInterval(interval);
    clearInterval(button_interval);
    $('#carousel-image1').css('transform', 'translateX(-108vw)');
    $('#carousel-image2').css('transform','translateX(-108vw)');
    $('#carousel-image3').css('transform','translateX(-101.617021277vw)');
